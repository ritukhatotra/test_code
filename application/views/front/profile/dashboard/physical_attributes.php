                ...
                <div class="col-md-6">
                    <div class="form-group has-feedback">
                        ...
                        <?php 
                            ...
                            echo $this->Crud_model->select_html('decision', 'any_disability', 'name', 'edit', 'form-control form-control-sm selectpicker', $physical_attributes_data[0]['any_disability'], '', '', '');

                        ?>

                        <?php /*<input type="text" class="form-control no-resize" name="any_disability" value="<?=$physical_attributes_data[0]['any_disability']?>">*/?>

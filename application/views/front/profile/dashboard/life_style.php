...
<div class="row list-box-columns">
		...
		<div class="col-md-6">
		      <div class="row">								  
					...
					<div class="col-6 p-0"><?=$this->Crud_model->get_type_name_by_id('diet', $life_style_data[0]['diet'], 'diet_name')?></div>								  
					</div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group has-feedback">
                        ...
                        echo $this->Crud_model->select_html('diet', 'diet', 'diet_name', 'edit', 'form-control form-control-sm selectpicker',$life_style_data[0]['diet'], '', '', '');

                        ?>
                    <?php /*  <input type="text" class="form-control no-resize" name="diet" value="<?=$life_style_data[0]['diet']?>">*/ ?>
